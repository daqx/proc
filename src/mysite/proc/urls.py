...
urlpatterns=patterns('',
    ...
    # ============== TARIF PROFILE ===============
    (r'^tarif_plan/$', tarif.tarif_plan),
    (r'^tarif_plan/(\d+)$', tarif.tarif_plan_form),
    (r'^tarif_plan/(\d+)/delete$', tarif.tarif_plan_delete),
    (r'^tarif_plan/gen_from_base$', tarif.tarif_plan_gen_from_base),
    (r'^tarif_plan/gen$', tarif.tarif_plan_gen),
    (r'^tarif_plan/add/(\d+)/delete$', tarif.tarif_plan_delete),
    # ============== TARIF_ARR ============
